...
static mjpeg_playback_clock_poll_t poll_impl(
    mjpeg_playback_clock_state_t *state,
    uint64_t now_us)
{
...
static mjpeg_playback_clock_effect_t result_impl(
    mjpeg_playback_clock_state_t *state,
...
mjpeg_playback_clock_effect_t mjpeg_playback_clock_on_decode_result(
    ...
    uint32_t yield_interval)
{
    return result_impl(state, result, now_us, yield_interval);
}

mjpeg_playback_clock_poll_t mjpeg_playback_clock_legacy_poll(
    mjpeg_playback_clock_state_t *state,
    uint64_t now_us)
{
    mjpeg_playback_clock_poll_t poll = {0};
...
mjpeg_playback_clock_effect_t mjpeg_playback_clock_legacy_on_decode_result(
    mjpeg_playback_clock_state_t *state,
    mjpeg_playback_decode_result_t result,
    uint64_t now_us,
    uint32_t yield_interval)
