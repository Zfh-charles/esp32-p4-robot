...
$testBinary = Join-Path $env:TEMP "mjpeg_index_reader_test.exe"
...
$compileArgs = @(
    ...
    "-Werror",
    "-I$sourceDir",
    (Join-Path $projectRoot "tools\host_tests\mjpeg_index_reader_test.cc"),
    (Join-Path $sourceDir "mjpeg_index_reader.c"),
    "-o",
    $testBinary
)
