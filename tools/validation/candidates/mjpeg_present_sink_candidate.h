#ifndef MJPEG_PRESENT_SINK_CANDIDATE_H
#define MJPEG_PRESENT_SINK_CANDIDATE_H
...
/*
 * Offline G4-5 candidate. It preserves callback and WDT-observation ordering,
 * but owns no LVGL, panel, DMA, RTOS, decoder, cache or playback operation.
 */
